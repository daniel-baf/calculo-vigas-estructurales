...
Esta carpeta centraliza la documentacion de la app y, en particular, del flujo de diseno de vigas.
...
- Los diagramas se documentan con Mermaid.
- Los nombres de pasos siguen el orden visible en el wizard.
- Las unidades de ingenieria se mantienen como en UI (cm, m, kg/m2, etc.).
