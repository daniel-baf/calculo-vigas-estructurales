...
export function App() {
  return (
    <ThemeProvider defaultTheme="system" storageKey="vite-ui-theme">
      <AppHeader />
      <div className="min-h-[calc(100vh-3.5rem)] bg-background px-4 py-8 sm:py-12 relative flex flex-col items-center">
        {/* Encabezado */}
        ...
        <footer className="w-full max-w-2xl text-center mt-8 text-xs text-muted-foreground">
