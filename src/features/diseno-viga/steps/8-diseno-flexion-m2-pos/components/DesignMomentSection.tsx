...
type Props = Pick<M2PosState, "resultado">
...
export function DesignMomentSection({ resultado }: Props) {
  ...
  return (
    <div className="space-y-3 rounded-xl bg-muted/30 p-4">
      <ResultRow
        label="Momento sísmico mínimo M2(+)"
      ...
      <div className="flex items-center gap-2 rounded-lg bg-blue-500/5 p-2 text-xs font-medium text-blue-600">
        ...
        <span>
          El momento de diseño se calcula sobre la capacidad negativa φMn₂⁻
          del apoyo derecho, según NSR-10 / ACI 318-19 §18.6.3.2.
        </span>
      </div>
    </div>
  )
