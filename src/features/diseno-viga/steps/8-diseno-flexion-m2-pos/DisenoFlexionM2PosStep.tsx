...
export function DisenoFlexionM2PosStep(props: M2PosState) {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-bold tracking-tight text-foreground">
          Paso 8: Diseño a Flexión para Momento M2(+) Lado Derecho
        </h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Diseño del refuerzo longitudinal para el momento positivo en el apoyo
          derecho, derivado de la capacidad negativa φMn₂⁻.
        </p>
      </div>
      ...
      <StepSection title="Momento de Diseño M2(+)">
