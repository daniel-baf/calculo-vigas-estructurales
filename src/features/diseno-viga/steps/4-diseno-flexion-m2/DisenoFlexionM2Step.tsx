    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Diseño del refuerzo longitudinal para el momento negativo en el apoyo derecho.
        </p>
      </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-2 rounded-lg border border-indigo-100 bg-indigo-50 px-3 py-2 dark:border-indigo-900/30 dark:bg-indigo-900/20">
              ...
              <p className="text-xs leading-relaxed text-indigo-700 dark:text-indigo-300">
                ...
                <strong>D/C a 1.00</strong>, el diseño es más eficiente y se
                requerirá <strong>menos acero de cortante</strong> (estribos).
              </p>
            </div>
            <VariantsTable
              variantes={variantes}
