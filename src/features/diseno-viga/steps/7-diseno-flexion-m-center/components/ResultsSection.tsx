...
type Props = Pick<DisenoFlexionMCentroState, "resultado" | "asEtabs">
...
export function ResultsSection({ resultado, asEtabs }: Props) {
  ...
  const chequeoAsMin = resultado.asPropuesta > resultado.asMin
  ...
  return (
    <div className="space-y-2">
      <ResultRow
        ...
        unit="cm²"
        status={chequeoAsMin ? "ok" : "warn"}
        hint={chequeoAsMin ? "Ok" : "Asmin"}
