          ...
          <div className="space-y-3">
            <div className="flex items-start gap-2 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 px-3 py-2 border border-indigo-100 dark:border-indigo-900/30">
              ...
              <p className="text-xs text-indigo-700 dark:text-indigo-300 leading-relaxed">
                <strong>Tip de optimización:</strong> Un diseño con <strong>D/C cercano a 1.00</strong> reduce la necesidad de estribos por cortante.
              </p>
            </div>
            <VariantsTable 
              variantes={variantes} 
        ...
        <>
          ...
          <section>
            <div className="flex items-center justify-between rounded-xl border border-border bg-card px-5 py-4">
              <span className="text-sm font-semibold">Armado superior (L. Izquierdo)</span>
